...
kmutex_init(kmutex_t *mtx)
{
	...
	sched_queue_init(&mtx->km_waitq);       /* wait queue */
        mtx->km_holder=NULL;      /* current holder */
}
...
kmutex_lock(kmutex_t *mtx)
{
  ...
  /*dbg(DBG_PRINT,"*****************************************Entering kmutex_lock\n");*/
...
/*dbg(DBG_PRINT,"*****************************************Entering kmutex_unlock\n");*/
...
/*  dbg(DBG_PRINT,"*****************************************Entering kmutex_lock_cancellable\n");*/
	KASSERT(curthr && (curthr != mtx->km_holder));
...
/*dbg(DBG_PRINT,"*****************************************Leaving kmutex_lock_cancellable\n");*/
        return 0;
}
